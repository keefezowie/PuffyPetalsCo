...
export function getDemoInventoryState(): InventoryState {
  ...
  const pearlVariants: MaterialVariant[] = pearlSizes.map((item) => {
    ...
    return {
      ...
      minPurchaseQuantity: item.sizeMm === 12 ? estimate.roundedPcs : 0,
      purchaseIncrementQuantity: item.sizeMm === 12 ? estimate.roundedPcs : 0,
      usageUnit: "pcs",
      active: true,
      notes:
        item.sizeMm === 12
